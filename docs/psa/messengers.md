...
_:material-update: Updated: 2022-06-04_

:material-calendar: 2022-05-06
...
As I mentioned in the [Intro post](/blog/psa/intro/), privacy, security and anonymity are different things, and that's gonna be a little clearer in this post as we compare different messengers.
...
!!! recommendation
    ### **:material-twitter: Twitter DMs and :material-reddit: Reddit Chat**
...
This is the section with the most well-known messaging apps. A lot of the trust comes down to the apps and/or servers being closed-source. Closed-source essentially means that a service, like WhatsApp, could _say_ that your messages aren't being looked at, but there's no real way to verify that, since you can't see the source code. The importance of open source was highlighted in my [Intro post](/blog/psa/intro#open-source-everything).
...
!!! recommendation
    ...
    !!! quote "[WhatsApp FAQ](https://faq.whatsapp.com/general/security-and-privacy/end-to-end-encryption)"
        _messages, photos, videos, voice messages, documents, status updates and calls_
    ...
    !!! quote "[WhatsApp encryption whitepaper](https://www.whatsapp.com/security/WhatsApp-Security-Whitepaper.pdf)"
        _Communications with a recipient who elects to use a vendor to manage their API endpoint are not considered end-to-end encrypted._
    ...
    However, since WhatsApp (probably) does use end-to-end encryption, it's one of the less bad options on this list. Security-wise, I think WhatsApp is fine, most of its issues come from the privacy-invasive practices of Meta/Facebook. If you have **_absolutely no other option_**, or you trust Meta/Facebook for whatever reason, WhatsApp is mostly fine to use. However, I would recommend that you try out other platforms like [**Signal**](#signal), [**Threema**](#threema) or [**Session**](#session) first, since they are much more private and secure than WhatsApp ever will be.
...
!!! recommendation
    ### **:material-facebook-messenger: Facebook Messenger and :material-instagram: Instagram DMs**
...
!!! recommendation
    ...
    **Signal** is an open source messenger (and a [nonprofit foundation](https://en.wikipedia.org/wiki/Signal_Foundation)) that uses their own [Signal Protocol](https://en.wikipedia.org/wiki/Signal_Protocol) for end-to-end encryption. This protocol is used by a whole bunch of other messengers, like [WhatsApp](https://signal.org/blog/whatsapp-complete/), [Google's RCS Chat](https://www.theverge.com/2020/11/19/21574451/android-rcs-encryption-message-end-to-end-beta), [Facebook Messenger's Secret Conversations](https://signal.org/blog/facebook-messenger/) and [Skype's Private Conversations](https://signal.org/blog/skype-partnership/).
    ...
    The Signal Protocol has been [audited](https://en.wikipedia.org/wiki/Signal_Protocol#History) multiple times and has been found to be "cryptographically sound". It's used by some of the largest companies out there, so clearly they've done it right. Nothing is 100% secure, but the Signal Protocol is one of, if not _the_ best, encryption protocol out there for messengers.
    ...
    [Website](https://signal.org/){.md-button} [:material-github:](https://github.com/signalapp "GitHub"){.card-link} [:material-file-document-multiple:](https://signal.org/legal/ "Terms and Privacy Policy"){.card-link} [:material-heart:](https://signal.org/donate/ "Donate"){.card-link}
    
    ??? downloads
        [:material-microsoft-windows: Windows](https://signal.org/download){.card-link}
        [:material-apple: macOS](https://signal.org/download){.card-link}
        [:material-linux: Linux](https://signal.org/download){.card-link}
        [:material-google-play: Play Store](https://play.google.com/store/apps/details?id=org.thoughtcrime.securesms){.card-link}
        [:material-apple-ios: App Store](https://apps.apple.com/us/app/signal-private-messenger/id874139669){.card-link}
        [:material-android: Android APK](https://signal.org/android/apk/){.card-link}

!!! recommendation
    ### **:tcgmoo-session: Session**
    ...
    **Session** is a fork of Signal that's meant to provide you with complete anonymity. Just like Signal, it's open source. That's about where the similarities end, though.
    ...
    [Website](https://getsession.org/){.md-button} [:material-github:](https://github.com/oxen-io "Github"){.card-link} [:material-file-document:](https://getsession.org/privacy-policy "Privacy Policy"){.card-link} [:material-file-document-outline:](https://getsession.org/terms-of-service "Terms of Service"){.card-link}

    ??? downloads
        [:material-microsoft-windows: Windows](https://getsession.org/download){.card-link}
        [:material-apple: macOS](https://getsession.org/download){.card-link}
        [:material-linux: Linux](https://getsession.org/download){.card-link}
        [:material-google-play: Play Store](https://play.google.com/store/apps/details?id=network.loki.messenger){.card-link}
        [:material-apple-ios: App Store](https://apps.apple.com/app/id1470168868){.card-link}
        [:tcgmoo-f-droid: F-Droid](https://signal.org/android/apk/){.card-link}
        
!!! recommendation
    ### **:tcgmoo-element: Element/Matrix**
    ...
    **Element** is an open source decentralised messenger that uses the **Matrix** protocol to work. You can use [other Matrix clients](https://matrix.org/clients/) that may provide different UIs and features. I recommend Element since it provides the most complete Matrix experience, having been [founded by the team behind Matrix](https://element.io/#matrix-card).
    ...
    [Element Website](https://element.io/){.md-button} [:material-github:](https://github.com/vector-im "GitHub"){.card-link} [:material-file-document-multiple:](https://element.io/legal "Legal"){.card-link}
    
    [Matrix Website](https://matrix.org/){.md-button} [:material-github:](https://github.com/matrix-org "GitHub"){.card-link} [:material-file-document-multiple:](https://matrix.org/legal/ "Legal"){.card-link} [:material-heart:](https://matrix.org/supporters/ "Supporters"){.card-link}

    ??? downloads "Downloads for Element"    
        [:material-microsoft-windows: Windows](https://element.io/get-started){.card-link}
        [:material-apple: macOS](https://element.io/get-started){.card-link}
        [:material-linux: Linux](https://element.io/get-started){.card-link}
        [:material-google-play: Play Store](https://play.google.com/store/apps/details?id=im.vector.app){.card-link}
        [:material-apple-ios: App Store](https://apps.apple.com/app/vector/id1083446067){.card-link}
        [:tcgmoo-f-droid: F-Droid](https://f-droid.org/packages/im.vector.app/){.card-link}
        [:material-web: Web client](https://app.element.io/){.card-link}
        
!!! recommendation
    ### **:tcgmoo-threema: Threema**
    **Threema** is probably one of the most feature-rich messengers that actually keeps your privacy and security in mind. They use [end-to-end encryption](https://threema.ch/en/faq/why_secure) with the open source [NaCl](https://nacl.cr.yp.to/) library. They have open source clients and have been [audited](https://threema.ch/en/blog/posts/audit-2020-en), which makes them quite easy to recommend. Threema is also based in Switzerland, the country with some of the [strongest data](https://en.wikipedia.org/wiki/Information_privacy_law#Switzerland) [protection laws](https://datenrecht.ch/ndsg-en/) in the world, which, in my opinion, gives them an edge over the other messengers, most of which are [based in the US](https://en.wikipedia.org/wiki/Information_privacy_law#United_States).
    ...
    !!! warning
        _After a bit more research, I've found out that Threema doesn't support group voice/video calls yet, though they do plan to add it. If this is a deal breaker for you, then I recommend using Signal or Session instead. In light of this discovery, I would recommend you go through the features that Threema does and doesn't offer, and if they're suitable for you, before purchasing the app._
        
    [Website](https://threema.ch/en){.md-button} [:material-github:](https://github.com/threema-ch "GitHub"){.card-link} [:material-file-document:](https://threema.ch/privacy_policy/ "Privacy Policy"){.card-link}
    
    ??? downloads
        [:material-microsoft-windows: Windows](https://threema.ch/en/download){.card-link}
        [:material-apple: macOS](https://threema.ch/en/download){.card-link}
        [:material-linux: Linux](https://threema.ch/en/download){.card-link}
        [:material-google-play: Play Store](https://play.google.com/store/apps/details?id=ch.threema.app){.card-link}
        [:material-apple-ios: App Store](https://apps.apple.com/app/threema/id578665578){.card-link}
        [:material-web: Web client](https://web.threema.ch/){.card-link}
        [:tcgmoo-threema: Threema Shop](https://shop.threema.ch/){.card-link}
---
...
- [x] How is the app's security? Are they utilising end-to-end encryption, and if so, which protocol? Has it been audited? How often is it updated? These are all highly important for security. [I've already covered why e2ee is necessary](/blog/psa/intro/#end-to-end-encryption-e2ee). Unaudited apps could have undiscovered security flaws and outdated apps may be behind on security patches.
- [x] Is it open source?
