...
See the entire code for this example below, or <a href="path/to/file" download="filename">download the file</a>.
...
Obviously if you want to have a *double* ratchet, you'll logically need a *single* ratchet.
