...
This example is going to get very big and complicated, so I'll try to comment the code to explain what some of the stuff mean and to show what's happening on device and server.
