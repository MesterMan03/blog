...
---
I've really gotten into this stuff over the 2 years or so. I probably shouldn't have, since I had a lot of (arguably) more important stuff going on during that time, and focusing on that might have been better for me and my future. But I digress.
...
However, the reality of the situation is that something being open source [doesn't necessarily give it](https://seirdy.one/posts/2022/02/02/floss-security/) an advantage or disadvantage in terms of privacy and security. There are many cases where a closed source product can be [more private and secure](https://madaidans-insecurities.github.io/firefox-chromium.html) than an open source one isn't. More than that, open source software also [isn't always the best](../operating-systems) in terms of user experience, and so even if it were more private, it wouldn't gain mass adoption.
...
By encrypting everything in transit, HTTPS ensures that no one can intercept and read any of those requests you're making. However, this doesn't stop them from hacking into or accessing any of those points (the DNS, the ISP, the website you're trying to access), which is why HTTPS is not a great measure of security. While it's better than not having it at all, you should not rely on it to properly secure your communications.
...
## What can I do?
Before you get started on your journey to making yourself more private, secure and/or anonymous, you should probably make a [threat model](./threat-modelling). This will help you better decide the tools you should use, and what steps to take.
